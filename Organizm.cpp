...
Organizm::Organizm(Swiat* biezacySwiat, int sila, int inicjatywa, int polozenieX, int polozenieY, int dlugoscZycia)
	...
	this->czyUmarl = 0;
	this->czySzybkoscAktywna = 0;
	this->szybkoscAntylopy = 0;
...
int Organizm::getSzybkoscAntylopy() {
	return this->szybkoscAntylopy;
}

bool Organizm::getCzySzybkoscAktywna(){
	return this->czySzybkoscAktywna;
}
...
void Organizm::setSzybkoscAntylopy(int szybkoscAntylopy) {
	this->szybkoscAntylopy = szybkoscAntylopy;
}

void Organizm::setCzySzybkoscAktywna(bool czySzybkoscAktywna) {
	this->czySzybkoscAktywna = czySzybkoscAktywna;
}
